...
const modal_region_and_coin_body = document.querySelector(
  ".modal-region-and-coin-body "
);
...
const modal_region_and_coin_option1 = document.querySelector(
  ".modal-region-and-coin_option1"
);
const modal_region_and_coin_option2 = document.querySelector(
  ".modal-region-and-coin_option2"
);
...
const favor_list_btn_default = document.querySelectorAll(
  ".favor-list-btn-default"
);
...
nav_moblie_btn.forEach(function (item, index) {
  ...
  item.onclick = function (e) {
    e.stopPropagation();
    document
      .querySelector(".nav-mobile-btn.nav-mobile-btn-active")
      .classList.remove("nav-mobile-btn-active");
...
function validator(option) {
  ...
  var validate = (inputElement, rule) => {
    ...
    if (errorMessage) {
      ...
      getParent(inputElement, option.formGroupSelector).classList.add(
        "regist-phoneNumber-form-correct"
      );
